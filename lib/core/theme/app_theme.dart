...
class AppTheme {
  ...
  /// Use in MaterialApp: theme: AppTheme.dark
  static ThemeData get dark {
    ...
    return base.copyWith(
      ...
      // Cards (rounded, no hard elevation; add shadows in widgets when needed)
      ...
      // Chips (filters, mobility, categories)
      chipTheme: base.chipTheme.copyWith(
        shape: const StadiumBorder(side: BorderSide(color: _outline)),
      ...
      // Material3 navigation bar (if used)
  ...
  static ThemeData get light {
    ...
    return base.copyWith(
      ...
      chipTheme: base.chipTheme.copyWith(
        shape: const StadiumBorder(side: BorderSide(color: _outlineLight)),
